...
TEST_F(StatsUploaderTest, ResetPersistentMetricsTest) {
  const TCHAR* keys[] = {
    _T("HKCU\\Software\\") REG_KEY_NAME _T("\\") PRODUCT_NAME _T("\\UsageStats\\Daily\\Timings"),  // NOLINT
    _T("HKCU\\Software\\") REG_KEY_NAME _T("\\") PRODUCT_NAME _T("\\UsageStats\\Daily\\Counts"),   // NOLINT
    _T("HKCU\\Software\\") REG_KEY_NAME _T("\\") PRODUCT_NAME _T("\\UsageStats\\Daily\\Integers"), // NOLINT
    _T("HKCU\\Software\\") REG_KEY_NAME _T("\\") PRODUCT_NAME _T("\\UsageStats\\Daily\\Booleans"), // NOLINT
  };
...
TEST_F(StatsUploaderTest,
       AggregateAndReportMetrics_KDSUpdateEulaNotAccepted_DoNotForce) {
...
// does not update 'LastTransmission'.
TEST_F(StatsUploaderTest,
       AggregateAndReportMetrics_KDSUpdateEulaNotAccepted_Force) {
  EXPECT_SUCCEEDED(RegKey::SetValue(USER_REG_UPDATE,
                                    _T("eulaaccepted"),
                                    static_cast<DWORD>(0)));
